package oop.example.baseentity;
...
public class Program {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student(id, now, now, "Tom", "Smith", "tommy hammer");
		...
		BaseEntity student2 = new Student(id, now, now, "Kevin", "Park", "KtotheP");
		...
		Course comp2500 = new Course(id, now, now, "COMP2500", "Java");
		
		id = UUID.randomUUID();
		now = OffsetDateTime.now(ZoneOffset.UTC);
		
		CourseTerm term202005 = new CourseTerm(id, now, now, comp2500, 202005);
	...
	private static void printStudentInformation(Student student) {
		...
		System.out.printf("name: %s%s", student.getName(), System.lineSeparator());
		System.out.printf("email: %s%s", student.getEmail(), System.lineSeparator());
		System.out.printf("nickname: %s%s", student.getNickname(), System.lineSeparator());
